...
SPEC-37 owns provisioning and verification after SPEC-36 merges. Until then,
the hosted Supabase database and the laptop-local backend environment must not
be described as a deployed application.
