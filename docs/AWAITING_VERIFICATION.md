...
| SPEC-36 corridor implementation | Branch `351bc06`, Sep 6 2026 | Fix remaining compile and scrolling defects; add Home/CitySection/repository and backend behavioral proofs; then independent Flutter validation, CI, and merge |
