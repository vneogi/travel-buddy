...
| SPEC-36 corridor implementation | Branch `f117967`, Sep 6 2026 | Replace helper-only date tests with Home/form behavior; strengthen CitySection and cross-city next-node widget proofs; assert cancel/swap mutations; add direct LLM sabotage; then Flutter validation, CI, and merge |
