...
1. With SPEC-41 A3b complete at `7f25042` and SPEC-10 paste plus
   flight/hotel scheduler on main, finish SPEC-25 grounded trip-scoped Ask
   after laptop tests, then the Laos hosted/API/APK re-verification.
